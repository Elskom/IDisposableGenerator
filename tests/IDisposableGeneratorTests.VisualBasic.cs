...
public partial class IDisposableGeneratorTests
{
    ...
    public async Task TestGeneratingPublicDisposableNotOwnsVisualBasic()
        => await SGAssert.RunTest<VBGeneratorTest>(@"' <autogenerated/>
Imports System
...
", null);
    ...
    public async Task TestWithoutThrowIfDisposedVisualBasic()
    {
        ...
        await SGAssert.RunTest<VBGeneratorTest>(generatedSource, testSource, null);
    }

    [Fact]
    public async Task TestGeneratingDisposableWithReadonlyFieldsVisualBasic()
    {
        const string generatedSource = """
            ' <autogenerated/>
            Imports System
            ...
            Namespace Test
                ...
                Public Partial Class LogWriter
                    ...
                    Public Sub WriteLine(ByVal text As String)
                        _streamWriter.WriteLine(text.ToUpper())
                    End Sub
                End Class
            End Namespace
            """;
    ...
    [Fact]
    public async Task TestGeneratingDisposableWithoutNamespaceVisualBasic()
    {
        const string generatedSource = """
            ' <autogenerated/>
            Imports System
